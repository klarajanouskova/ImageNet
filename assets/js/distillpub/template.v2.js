...
`);
  ...
  var byline = "/*\n * Copyright 2018 The Distill Template Authors\n *\n * Licensed under the Apache License, Version 2.0 (the \"License\");\n * you may not use this file except in compliance with the License.\n * You may obtain a copy of the License at\n *\n *      http://www.apache.org/licenses/LICENSE-2.0\n *\n * Unless required by applicable law or agreed to in writing, software\n distributed under the License is distributed on an \"AS IS\" BASIS,\n * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n See the License for the specific language governing permissions and limitations under the License. */ d-byline { contain: style; overflow: hidden; border-top: 1px solid rgba(0, 0, 0, 0.1); font-size: 0.8rem; line-height: 2em; padding: 1.5rem 0; min-height: 2.5em; } d-byline .byline { display: grid; grid-template-columns: 40% 60%; grid-template-rows: auto auto; grid-column: text; margin-bottom: 0.5em; } @media(min-width: 768px) { d-byline .byline { grid-template-columns: 40% 60%; grid-template-rows: auto auto; margin-bottom: 0.5em; } } d-byline .authors-affiliations { display: grid; grid-template-columns: 40% 60%; grid-column-end: span 2; margin-bottom: 1.5em; } @media(min-width: 768px) { d-byline .authors-affiliations { margin-bottom: 1.5em; } } d-byline h3 { font-size: 0.7rem; font-weight: 300; color: rgba(0, 0, 0, 0.5); margin: 0; text-transform: uppercase; margin-bottom: 1em; } d-byline .author-label { font-size: 0.75rem; font-weight: 500; color: rgba(0, 0, 0, 0.8); margin: 0; margin-bottom: 0em; display: inline; text-decoration: none; } d-byline p { margin: 0; } d-byline a, d-article d-byline a { color: rgba(0, 0, 0, 0.8); text-decoration: none; border-bottom: none; } d-article d-byline a:hover { text-decoration: none; border-bottom: none; } d-byline p.author { font-weight: 500; } d-byline h3 + p, d-byline h3 + div, d-byline h3 + span { text-decoration: none; } d-byline .author-info { display: flex; align-items: center; gap: 0.5em; margin-top: 0.5em; } d-byline p.mail { font-size: 0.75rem; font-weight: 300; color: rgba(0, 0, 0, 0.8); margin: 0; display: inline; } d-byline p.mail a { color: rgba(0, 0, 0, 0.8); }";
